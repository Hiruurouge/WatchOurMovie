...
def create_preference(preferences: List[Preferences], db: Session):
...
def delete_preferences(preferences:Preferences,db:Session):
...
def update_preferences(old_preferences: Preferences,new_preferences:Preferences, db:Session):
